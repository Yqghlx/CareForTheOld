...
前端 359 个 Flutter 测试（表单验证、全模型序列化覆盖、AuthState 测试、OCR 解析器 27 个、VoiceParser 34 个、全部 18 个 Service 层 100% 覆盖、烟雾测试），使用 mocktail mock Dio。测试目录：`flutter_client/test/`。
