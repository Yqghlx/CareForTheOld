        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              AnimatedQuickCard(
                icon: Icons.favorite,
                title: AppTheme.titleRecordHealth,
                subtitle: AppTheme.subtitleRecordHealth,
                color: AppTheme.errorColor,
                onTap: () => setState(() => _selectedIndex = 1),
              ),
              AnimatedQuickCard(
                icon: Icons.medication,
                title: AppTheme.msgMedicationReminder,
                subtitle: AppTheme.subtitleViewTodayMed,
                color: AppTheme.infoBlue,
                onTap: () => setState(() => _selectedIndex = 2),
              ),
              AnimatedQuickCard(
                icon: Icons.people,
                title: AppTheme.titleFamilyMember,
                subtitle: AppTheme.subtitleFamilyMembers,
                color: AppTheme.successColor,
                onTap: () => context.push(RoutePaths.elderFamily),
              ),
              AnimatedQuickCard(
                icon: Icons.diversity_3,
                title: AppTheme.titleNeighborCircle,
                subtitle: AppTheme.subtitleNeighborCircle,
